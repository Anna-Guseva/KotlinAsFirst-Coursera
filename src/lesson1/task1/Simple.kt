 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = sqrt(Math.pow((x1 - x2), 2.0) + Math.pow((y1 - y2), 2.0))
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    return if (hoursDepart <= hoursArrive)
        (hoursArrive * 60 + minutesArrive - hoursDepart * 60 - minutesDepart)
    else
        (1440 - hoursDepart * 60 - minutesDepart + hoursArrive * 60 + minutesArrive)
}
